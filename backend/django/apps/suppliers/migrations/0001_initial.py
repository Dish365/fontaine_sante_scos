    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("small_truck", "Small Truck (< 3.5 tons)"),
                            ("medium_truck", "Medium Truck (3.5-16 tons)"),
                            ("large_truck", "Large Truck (> 16 tons)"),
                            ("electric_vehicle", "Electric Vehicle"),
                            ("hybrid_vehicle", "Hybrid Vehicle"),
                        ],
                        help_text="Type of vehicle (for road transport)",
                        max_length=20,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.FloatField(
                        help_text="Base emission factor in kg CO2e per km",
                ...
                (
                    "volume_factor",
                    models.FloatField(
                        help_text="Volume impact factor",
                        validators=[django.core.validators.MinValueValidator(0)],
                    ),
                ),
                (
                    "load_factor_impact",
                    models.FloatField(
                        help_text="Load factor impact on emissions",
                        validators=[django.core.validators.MinValueValidator(0)],
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="suppliers.SupplierMaterial",
                to="suppliers.material",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Type of vehicle (required for road transport)",
                        max_length=20,
                        null=True,
                    ),
                ),
                ...
                (
                    "load_factor",
                    models.FloatField(
                        help_text="Load factor (0-1) representing how full the vehicle is",
                        validators=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether to include return trip emissions",
                    ),
                ),
                (
                    "total_emissions",
                    models.FloatField(
                        help_text="Total emissions in kg CO2e",
                        validators=[django.core.validators.MinValueValidator(0)],
                    ),
                ),
                (
                    "emissions_per_km",
                    models.FloatField(
                        help_text="Emissions per kilometer",
                        validators=[django.core.validators.MinValueValidator(0)],
                    ),
                ),
                (
                    ...
                    models.FloatField(
                        help_text="Emissions per cubic meter",
                        validators=[django.core.validators.MinValueValidator(0)],
                    ),
                ),
                (
                    ...
                    models.FloatField(
                        help_text="Transport efficiency score (0-100)",
                        validators=[
                            django.core.validators.MinValueValidator(0),
